                    ...
                    <div class="relative inline-block text-left" x-data="{ openLang: false }">
                        ...
                        <div x-cloak x-show="openLang" x-transition @click.outside="openLang = false"
                            ...
                            <a href="{{ route('lang.switch', 'ar') }}"
                                class="block px-4 py-2 text-sm hover:bg-gray-100 {{ app()->getLocale() == 'ar' ? 'font-semibold' : '' }}">
                                العربية
                            </a>

                            <a href="{{ route('lang.switch', 'en') }}"
                                class="block px-4 py-2 text-sm hover:bg-gray-100 {{ app()->getLocale() == 'en' ? 'font-semibold' : '' }}">
                                English
                            </a>
                        </div>
                    </div>
