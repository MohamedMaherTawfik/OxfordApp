                                ...
                                <div class="edit-profile__body">
                                    <form>
                                        ...
                                        <div class="form-group mb-25">
                                            ...
                                            <input type="email" class="form-control" id="phoneNumber2"
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group mb-25 form-group-calender">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <a href="#"><img class="svg" src="img/svg/chevron-right.svg"
                                                        alt="chevron-right"></a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex">
                                                <div class="radio-horizontal-list d-flex flex-wrap">
                                                    ...
                                                    <div class="radio-theme-default custom-radio ">
                                                        <input class="radio" type="radio" name="radio-optional"
                                                            value=0 id="radio-hl1">
                                                        <label for="radio-hl1">
